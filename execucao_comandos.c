...
void analisa_player(char *comando, PonteiroLetra *raiz, PonteiroPlayer **tabela_players1, Jogadores *vetor_medias)
{
    char prefixo[DIMENSAO_GERAL];
    int j = 0;
...
void comando_userID(char *comando, PonteiroPlayer **tabela_players2,PonteiroUser **tabela_rating, Jogadores *vetor_medias)
{
...
void mostra_topdown(Comandos_1_3_4 *informacoes, int dimensao_vetor, int N)
{
    int count = 0;
...
void comando_top(char *position, int N, PonteiroPlayer **tabela_players3, PonteiroPlayer **tabela_players2, Jogadores *vetor_medias)
{
...
void controla_top (char *comando,PonteiroPlayer **tabela_players3, PonteiroPlayer **tabela_players2, Jogadores *vetor_medias)
{
...
void comando_tags(PonteiroPlayer **tabela_players2,Jogadores *vetor_medias,int **vetor_sofifas,int intersecoes, int quantidade_tags)
{
    Comandos_1_3_4 *informacoes;
    PonteiroPlayer *ptaux;
...
void controla_tags(char *comando,PonteiroPlayer **tabela_players2, PonteiroTag **tabela_tags, Jogadores *vetor_medias)
{
...
void comando_down(char *position, int N, PonteiroPlayer **tabela_players3, PonteiroPlayer **tabela_players2, Jogadores *vetor_medias)
{
    Comandos_1_3_4 *informacoes;
    int indice = hash(position,TOTALPOSITIONS);
    int indice2;
...
void controla_down (char *comando,PonteiroPlayer **tabela_players3, PonteiroPlayer **tabela_players2, Jogadores *vetor_medias)
{
    char numero[TAMANHONUMERO];
    int N;
    char posicao[DIMENSAO_POSITION];
...
void mostra_playerID(char *playerid, Comando6 *informacoes_users, PonteiroPlayer **tabela_players2, Jogadores *vetor_medias)
{
    int indice,indice2;
    PonteiroPlayer *ptaux;
...
void mostra_playerID2(char *playerid, Comando6 *informacoes_users, PonteiroTag **tabela_tags2, int dimensao_vetor)
{
    PonteiroTag *ptaux;
...
void comando_id(char *comando,PonteiroPlayer **tabela_players2,PonteiroTag **tabela_tags2,Jogadores *vetor_medias)
{
